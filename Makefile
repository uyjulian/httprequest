...
SOURCES := ../tp_stub.cpp ../ncbind/ncbind.cpp Base64.cpp encoding.cpp HttpConnection.cpp Main.cpp match.cpp init_guid.c
OBJECTS := $(SOURCES:.c=.o)
OBJECTS := $(OBJECTS:.cpp=.o)

BINARY ?= httprequest.dll
ARCHIVE ?= httprequest.$(GIT_TAG).7z
